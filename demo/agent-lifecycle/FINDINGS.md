...
> 记录 IM 渠道激活方案（`docs/plans/im-channel-activation.md`）相关的**方案/调研结论**与**实测结果**。
>
> 关联设计：`docs/plans/im-channel-activation.md` 的三层信号模型——
...
## 9. 对设计 doc 的影响（建议回写 `docs/plans/im-channel-activation.md`）
